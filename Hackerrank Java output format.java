...
Explanation: Each String is left-justified with trailing whitespace through the first 15 characters. 
 The integer expressed in exactly 3 digits; if the original input has less than three digits, you must pad your output's leading digits with zeroes.
*/
...
public class Solution {
    ...
    public static void main(String[] args) {
            ...
            for(int i=0;i<3;i++)
            {
                String s1=sc.next();
                int x=sc.nextInt();
                System.out.printf("%-15s%03d\n",s1,x);//-%15s indicates each  string left-justify with 15 character(without '-' it indicates right-justify) .
            }                                        //%03d indicates integer expressed in 3 digits.
                                                     // for next line we cna use (\n or %n).
            System.out.println("================================");
